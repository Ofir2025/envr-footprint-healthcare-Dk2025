...
| `Health care` | measure | float64 |  | 74.8 |
| `Per person` | measure | float64 |  | 12.7 |
| `Danish total` | measure | float64 |  | 1276.1 |
| `Share of national (%)` | measure | float64 | % | 5.9 |
...
| `Impact category` | dimension | str |  | Blue water consumption |
| `Unit` | dimension | str |  | Mm³ |
| `2019` | measure | float64 |  | 50.3 |
| `2022` | measure | float64 |  | 74.8 |
| `Change (%)` | measure | float64 |  | 48.8 |
...
| `Scope 3` | measure | float64 |  | 74.61 |
| `Outside protocol` | measure | float64 |  | 0.1 |
| `TOTAL` | measure | float64 |  | 74.78 |
...
| `Health care (kt CO₂-eq)` | measure | float64 |  | 3253.8 |
...
| `Impact category` | dimension | str |  | Blue water consumption |
| `Unit` | dimension | str |  | Mm³ |
| `Capital excluded (headline)` | measure | float64 |  | 74.6 |
| `Capital as a service flow` | measure | float64 |  | 81.6 |
| `Capital endogenised` | measure | float64 |  | 84.2 |
| `Endogenised change (%)` | measure | float64 |  | 12.9 |
...
| `Deterministic` | measure | float64 |  | 4266.9 |
| `Median` | measure | float64 |  | 4289.0 |
| `2.5th percentile` | measure | float64 |  | 3674.8 |
| `97.5th percentile` | measure | float64 |  | 5028.9 |
| `CV, Tier 2 (%)` | measure | float64 |  | 8.0 |
| `CV, Tier 1 (%)` | measure | float64 |  | 8.04 |
...
| `Share of variance (%)` | measure | float64 | % | 69.6 |
