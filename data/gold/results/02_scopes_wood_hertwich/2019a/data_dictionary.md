# 02_scopes_wood_hertwich/2019a - data dictionary
...
| `value` | measure | float64 | varies by row | 7267.63062071606 |
...
| `value` | measure | float64 | varies by row | 0.1084252496002659 |
...
| `value` | measure | float64 | kt CO2eq | 0.0037892390474896 |
...
| `value` | measure | float64 | varies by row | 152.10093671061043 |
