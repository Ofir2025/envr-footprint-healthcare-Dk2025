# 02_scopes_wood_hertwich/2022d - data dictionary
...
| `value` | measure | float64 | varies by row | 5202.009156920027 |
...
| `value` | measure | float64 | varies by row | 0.0973758018470864 |
...
| `value` | measure | float64 | kt CO2eq | 0.0032640134210562 |
...
| `value` | measure | float64 | varies by row | 172.67889247050002 |
