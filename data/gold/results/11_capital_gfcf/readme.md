...
Method, equations, and verification: [`docs/methods/replications.md`, section 11](../../../../docs/methods/replications.md#r11).
...
- **Rows:** 6,870
- **Format:** csv
- **Resolution:** 41+ regions x 87+ industries (sampled)
- **Units:** kt CO2eq
