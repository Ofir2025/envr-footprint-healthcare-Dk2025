...
| `10_sea_transport_reallocation` | the sea-transport reallocation, on which the corrected transport share depends |
...
|:---|:---|
| `18_mitigation_scenarios` | the counterfactual mitigation scenarios; held back from the revision on 14 September 2026 for the follow-up paper |
