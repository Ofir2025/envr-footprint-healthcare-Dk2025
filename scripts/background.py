...
additions by: Michelle Steenmeijer
"""
...
#year = '2016'
#definition = 'Intl' # 'Intl' / 'Breed'
#system = 'Zorgwelzijn' # 'Zorgwelzijn' / 'GezZorg'
#print('Analysejaar: ', year)
#print('Configuratie: ', definition, system)
