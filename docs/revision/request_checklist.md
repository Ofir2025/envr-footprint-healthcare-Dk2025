...
| 12 | **Use the assembled literature as source of truth before online sources** | **Done** - the local reference library (`docs/reference_library.md`) is checked first; online sources are used only for genuine gaps, and each such use states why the local library was insufficient | - |
