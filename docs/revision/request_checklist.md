...
| 15 | **EXIOBASE vintage integrity (not requested - found)** | **Done** | v3.10.2's 2022 Danish block fails against national accounts; background moved to v3.8.2. `docs/methods/exiobase_version_vintage_and_classification.md`, `analysis.vintage_defect_audit` → `09_vintage_diagnostics/` |
