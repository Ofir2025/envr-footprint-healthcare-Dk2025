...
| 15 | **EXIOBASE release integrity (not requested - found)** | **Done** | v3.10.2's 2022 Danish block fails against national accounts; background moved to v3.8.2. `docs/methods/exiobase_release_and_classification.md`, `analysis.release_defect_audit` → `09_exiobase_release_diagnostics/` |
