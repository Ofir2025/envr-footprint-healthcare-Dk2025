...
Nothing is assumed beyond multiplication and the idea of an average. Section 10
carries the same material restated as manuscript and Supplementary Information
prose, ready to paste with light editing; sections 1-9 are why that prose is
true.
...
## 10. Manuscript and SI text, ready to paste
...
1-9 as publication prose rather than derivation; nothing here introduces a
...
### 10.3 Three properties stated explicitly

A referee may otherwise raise these, and each is now reported. (a) and the
correlation table restate section 4.5 above; (b) restates section 4.1(b); (c)
restates section 6.2. They are repeated here as self-contained prose because
that is what makes them pasteable.
...
### 10.4 The limitation to paste alongside the interval

Reproduced from section 8 above so this section is self-contained:
...
### 10.5 Parameter table for the supplementary information
...
### 10.6 Supplementary Information: section S*n*, ready to paste
...
numbered S1-S7; the plain-English derivation of each is in sections 3-4 above.
...
- Rodrigues JFD (2016) Maximum-entropy prior uncertainty and correlation of
  statistical economic data. *Journal of Business & Economic Statistics*
  34(3):357-367.
