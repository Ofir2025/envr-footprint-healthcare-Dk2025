...
A note prompted by a fair challenge: an earlier memo mentioned OECD **ICIO**.
...
Worth adding for two purposes, neither of which the European sources cover:
...
Not yet implemented; listed as the next optional layer.
