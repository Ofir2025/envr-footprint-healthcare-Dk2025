...
| 3 | **Malik replication folder** for all of Denmark | **In progress** — implementation spec being extracted from Malik 2018/2021 + SIs | `07_malik_replication/` |
| 4 | **Lenzen replication folder**, his equations and full KPI set for Denmark | **In progress** — spec being extracted from the paper + 3 SI PDFs | `08_lenzen_replication/` |
| 5 | **FIGARO — did we make enough of it?** | Partly: used as an independent denominator (57.40 Mt) and NACE-Q cross-check. More to extract (Q86 vs Q87-88 recipe validation, import structure) | `06_benchmarks_validation/`, `docs/revision/data_sources_and_models.md` |
